...
export const EVENTS = [
  {
    id: 'vermont', theme: 'vermont', nation: '🇺🇸', flag: '🍁',
  ...
  {
    id: 'quebec', theme: 'quebec', nation: '🇨🇦', flag: '⚜️',
  ...
  {
    id: 'colorado', theme: 'colorado', nation: '🇺🇸', flag: '🏔️',
  ...
  {
    id: 'utah', theme: 'utah', nation: '🇺🇸', flag: '🎿',
  ...
  {
    id: 'chile', theme: 'chile', nation: '🇨🇱', flag: '🌋',
  ...
  {
    id: 'japan', theme: 'japan', nation: '🇯🇵', flag: '🏮',
